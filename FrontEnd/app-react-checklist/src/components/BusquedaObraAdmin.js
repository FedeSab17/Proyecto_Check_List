...
const BusquedaObraAdmin = (props) => {
    ...
    const enviarDatos = async (obra, event) => {
        ...
        //Guardo el n° de obra en el localStorage =>
        localStorage.setItem("nObraUpdate", obra.codigo)
    ...
    return(
        ...
        <Fragment>
            ...
            <Alert.Heading className="alertTitle">BUSQUEDA POR N° DE OBRA</Alert.Heading>
...
export default BusquedaObraAdmin