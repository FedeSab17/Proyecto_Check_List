...
const PrincipalAberturasUpdate = (props) => {
    ...
    if(dato === null){
        ...
        return(
            ...
            <Fragment>
                ...
                <Alert.Heading className="alertTitle">LISTA DE ABERTURAS PARA ACTUALIZACION</Alert.Heading>
...
export default PrincipalAberturasUpdate