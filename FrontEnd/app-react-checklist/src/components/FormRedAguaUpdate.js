...
const FormRedAguaUpdate = (props) => {
    ...
    const cargarDatos = async() => {   
        ...
        try{
            ...
            const response = await axios(`${process.env.REACT_APP_KEY}Proyecto_CheckList/RedAguaServlet`,{
            ...
            localStorage.setItem("idAguaUpdate", resJson.idAgua)
    ...
    const actualizar = async(red) => {
        ...
        try{
            ...
            let idAgu = localStorage.getItem("idAguaUpdate")
    ...
    return(
        ...
        <Fragment>
            ...
            <Alert.Heading className="alertTitle">FORMULARIO DE ACTUALIZACION DE RED AGUA</Alert.Heading>
...
export default FormRedAguaUpdate