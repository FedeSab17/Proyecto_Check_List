        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    ControladorSeco c1 = new ControladorSeco();
                    Seco seco = c1.buscarOneSeco(Long.parseLong(request.getParameter("idSeco"))); 
                    Gson gsonBuilder = new GsonBuilder().create();
                    ...
                    double mLineales = Double.parseDouble(request.getParameter("mLineales"));
                    ...
                    ControladorSeco c1 = new ControladorSeco();  
                    Seco seco = new Seco(fechaInicio, fechaFinal, mLineales, mPerson, m2Muro, muroPerson, m2Cubierta, cubiertaPerson, metrosLineales, linealesPerson, diasCaidos, motivo, materialVigas, materialMuros, materialCubiertas, comentario, fechaAlta, fechaBaja, estado, idVisita);
                    c1.insertarSeco(seco);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String secoJson = gsonBuilder.toJson(seco);
                    respuestaServer = secoJson;
                    ...
                    Long idSeco = Long.parseLong(request.getParameter("idSeco")); 
                    LocalDate fechaInicio = LocalDate.parse(request.getParameter("fechaInicio"));
                    LocalDate fechaFinal = LocalDate.parse(request.getParameter("fechaFinal"));
                    double mLineales = Double.parseDouble(request.getParameter("mLineales"));
                    int mPerson = Integer.parseInt(request.getParameter("mPerson"));
                    ...
                    ControladorSeco c1 = new ControladorSeco();  
                    Seco seco = new Seco(idSeco, fechaInicio, fechaFinal, mLineales, mPerson, m2Muro, muroPerson, m2Cubierta, cubiertaPerson, metrosLineales, linealesPerson, diasCaidos, motivo, materialVigas, materialMuros, materialCubiertas, comentario, fechaAlta, fechaBaja, estado, idVisita);
                    c1.actualizarSeco(seco);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String secoJson = gsonBuilder.toJson(seco);
                    respuestaServer = secoJson;
                    ...
                    ControladorSeco c1 = new ControladorSeco();      
                    c1.eliminarSeco(Long.parseLong(request.getParameter("idSeco")));
                    List<Seco> listaSeco = c1.buscarAllSeco();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String secoJson = gsonBuilder.toJson(listaSeco);
                    respuestaServer = secoJson;
                    ...
                    ControladorSeco c1 = new ControladorSeco();   
                    c1.eliminarLogicoSeco(idSeco, fechaBaja);
                    List<Seco> listaSeco = c1.buscarAllSeco();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String secoJson = gsonBuilder.toJson(listaSeco);
                    respuestaServer = secoJson;
