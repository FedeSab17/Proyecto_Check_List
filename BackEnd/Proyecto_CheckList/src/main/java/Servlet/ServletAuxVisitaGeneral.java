...
//Se especifica el nombre y ruta de la clase: 'http://localhost:8080/Proyecto_CheckList/AuxVisitaGeneralServlet?
@WebServlet(name = "AuxVisitaGeneralServlet", urlPatterns = {"/AuxVisitaGeneralServlet"})
public class ServletAuxVisitaGeneral extends HttpServlet {
        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    List<AuxVisitaGeneral> listaAux = c1.buscarAllAuxVisitaGeneral(codigo);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String auxJson = gsonBuilder.toJson(listaAux);
                    respuestaServer = auxJson;
