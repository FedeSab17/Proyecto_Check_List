        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    ControladorRedAgua c1 = new ControladorRedAgua();
                    RedAgua redAgua = c1.buscarOneRedAgua(Long.parseLong(request.getParameter("idAgua"))); 
                    Gson gsonBuilder = new GsonBuilder().create();
                    ...
                    ControladorRedAgua c1 = new ControladorRedAgua();
                    RedAgua redAgua = new RedAgua(fechaInicio, fechaFinal, metrosLineales, nroPersonas, comentario, fechaAlta, fechaBaja, estado, idVisita);
                    c1.insertarRedAgua(redAgua);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String aguaJson = gsonBuilder.toJson(redAgua);
                    respuestaServer = aguaJson;
                    ...
                    //Se completa con los datos del ControladorAbertura
                    Long idAgua = Long.parseLong(request.getParameter("idAgua"));
                    LocalDate fechaInicio = LocalDate.parse(request.getParameter("fechaInicio"));
                    LocalDate fechaFinal = LocalDate.parse(request.getParameter("fechaFinal"));
                    double metrosLineales = Double.parseDouble(request.getParameter("metrosLineales"));
                    int nroPersonas = Integer.parseInt(request.getParameter("nroPersonas"));
                    ...
                    ControladorRedAgua c1 = new ControladorRedAgua();
                    RedAgua redAgua = new RedAgua(idAgua, fechaInicio, fechaFinal, metrosLineales, nroPersonas, comentario, fechaAlta, fechaBaja, estado, idVisita);
                    c1.actualizarRedAgua(redAgua);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String aguaJson = gsonBuilder.toJson(redAgua);
                    respuestaServer =  aguaJson;
                    ...
                    ControladorRedAgua c1 = new ControladorRedAgua();    
                    c1.eliminarRedAgua(Long.parseLong(request.getParameter("idAgua")));
                    List<RedAgua> listaRedAgua = c1.buscarAllRedAgua();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String aguaJson = gsonBuilder.toJson(listaRedAgua);
                    respuestaServer = aguaJson;
                    ...
                    ControladorRedAgua c1 = new ControladorRedAgua();     
                    c1.eliminarLogicoRedAgua(idAgua, fechaBaja);
                    List<RedAgua> listaRedAgua = c1.buscarAllRedAgua();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String aguaJson = gsonBuilder.toJson(listaRedAgua);
                    respuestaServer = aguaJson;
